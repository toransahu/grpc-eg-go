...
// Source: github.com/toransahu/grpc-eg-go/machine (interfaces: MachineClient,Machine_ServerStreamingExecuteClient,Machine_ServerStreamingExecuteServer,Machine_ExecuteServer,Machine_ExecuteClient)
...
func (m *MockMachine_ExecuteServer) SendAndClose(arg0 *machine.Result) error {
	m.ctrl.T.Helper()
...
func (mr *MockMachine_ExecuteServerMockRecorder) SendAndClose(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendAndClose", reflect.TypeOf((*MockMachine_ExecuteServer)(nil).SendAndClose), arg0)
}
...
func (m *MockMachine_ExecuteClient) CloseAndRecv() (*machine.Result, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMachine_ExecuteClientMockRecorder) CloseAndRecv() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseAndRecv", reflect.TypeOf((*MockMachine_ExecuteClient)(nil).CloseAndRecv))
}
